...
export const BitcoinScreen=()=>{
    ...
    const handleWithdraw =async ()=>{
        if(address === undefined || amount===undefined){
            ...
            setLoading(true)
            const res = await withdraw(user.username,{paymentType:'Bitcoin',address:address,amount:amount})
        ...
        <View   style={styles.container}>
          ...
          <View style={styles.child}>
              ...
              <View style={styles.action}>
                    <TextInput placeholder="BTC WALLET ADDRESS" placeholderTextColor="white" style={styles.textInput} autoCapitalize='none' onChangeText={(val)=>{HandleAddress(val)}}/>
                </View>
